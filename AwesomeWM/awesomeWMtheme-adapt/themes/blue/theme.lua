...
theme.wallpaper = "/home/vh/123.png"

-- Fonts  theme.path ..  "/123.jpg" -- wallpaper file
------------------------------------------------------------
theme.fonts = {
	main     = "Roboto 9",      -- main font
	menu     = "Roboto 9",      -- main menu font
	tooltip  = "Roboto 9",      -- tooltip font
	notify   = "Play bold 9",   -- redflat notify popup font
	clock    = "Play bold 9",   -- textclock widget font
	qlaunch  = "Play bold 9",   -- quick launch key label font
	keychain = "Play bold 9",   -- key sequence tip font
	title    = "Roboto bold 9", -- widget titles font
	titlebar = "Roboto bold 9", -- client titlebar font
	hotkeys = {
		main  = "Roboto 9",             -- hotkeys helper main font
		key   = "Iosevka Term Light 9", -- hotkeys helper key font (use monospace for align)
		title = "Roboto bold 9",        -- hotkeys helper group title font
	},
}

theme.cairo_fonts = {
	tag         = { font = "Play", size = 9, face = 1 }, -- tag widget font
  tag2         = { font = "fontawesome", size = 11, face = 1 }, -- tag widget font
	appswitcher = { font = "Play", size = 9, face = 1 }, -- appswitcher widget font
	navigator   = {
		title = { font = "Play", size = 9, face = 1, slant = 0 }, -- window navigation title font
		main  = { font = "Play", size = 9, face = 1, slant = 0 }  -- window navigation  main font
	},
}
...
theme.gauge.tag.blue = {
	width    = 40,
	font     = theme.cairo_fonts.tag2,
	point    = { width = 40, height = 2, gap = 14, dx = 2 },
	text_gap = 11,
	color    = theme.color
}
...
theme.gauge.task.blue = {
	...
	point    = { width = 40, height = 2, gap = 13, dx = 2 },
	text_gap = 12,
	color    = theme.color
}
...
theme.float.qlaunch = {
	...
	recoloring    = true,
	keytip        = { geometry = { width = 300, height = 160 } },
